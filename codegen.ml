...
let translate (globals, camFunctions, classes) =
  ...
  let printf_t : L.lltype =
      L.function_type float_t [| string_t |] in
  ...
  let add_circle_t : L.lltype =
      L.function_type float_t [| float_t; float_t; float_t; float_t;
      float_t; float_t; float_t |] in
  let add_circle_func : L.llvalue =
      L.declare_function "xadd_circle" add_circle_t the_module in
  ...
  let ccanvas_t : L.lltype =
      L.function_type float_t [| float_t; float_t; float_t; float_t |] in
  let ccanvas_func : L.llvalue =
      L.declare_function "add_ccanvas" ccanvas_t the_module in
  ...
  let build_function_body fdecl =
    ...
    | SCall ("add_canvas", [e1; e2; e3; e4]) ->
      ...
      "add_canvas" builder
  | SCall ("add_ccanvas", [e1; e2; e3; e4]) ->
    L.build_call ccanvas_func [| (expr builder e1); (expr builder e2); (expr builder e3); (expr builder e4);|]
    "add_ccanvas" builder
    | SCall (f, args) ->
